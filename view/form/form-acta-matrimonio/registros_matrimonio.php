...
<body>
    <div class="container-tittle">
        <h1 class="text-center">REGISTRO ACTAS DE MATRIMONIO</h1>
    </div>
<br>
    <div class="container-table p-3 table-responsive">

        <div class="container-agregar pb-2">
            <a href="form_matrimonio.php" class="btn btn-success"><img src="../../../imagenes/imagen_agregar.png" alt="" width="35px" height="26px" style="padding-right: 10px;">AGREGAR REGISTRO</a>
        </div>
        ...
        <table class="table table-bordered table-striped table-hover" id="myTable"> 
            ...
            <tbody>
                ...
                $sql = $conexion->query("SELECT * FROM acta_matrimonio 
                INNER JOIN tipoacta ON acta_matrimonio.id_tipo_acta = tipoacta.id_tipo_acta");            
                ...
                <tr class="text-center">
                    ...
                    <th scope="row"><?php echo $resultado["contrayente_masc"];?></th>
                    <th scope="row"><?php echo $resultado["contrayente_fem"];?></th>
                    <th scope="row"><?php echo $resultado["regimen"];?></th>
                    <td>
                    ...
                    <th>           
                        <a href="form_editar_acta.php?id=<?php echo $resultado['id_acta'];?>" class="btn btn-warning"><img src="../../../imagenes/imagen_editar.png" alt="" width="35px" height="26px" style="padding-right: 10px;">EDITAR</a>
                        <br><br>
                        <a href="../../../controladores/acta_matrimonio/eliminar_acta.php?id=<?php echo $resultado['id_acta'];?>" class="btn btn-danger btn-eliminar"><img src="../../../imagenes/imagen_borrar.png" alt="" width="35px" height="26px" style="padding-right: 10px;">ELIMINAR</a>
                    </th>
                </tr>
                <?php
                }
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <iframe id="pdfIframe" src="../../../storage/pdfs_matrimonio/" frameborder="0" style="width: 100%; height: 75vh;"></iframe>
        </div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  pdfModal.addEventListener("show.bs.modal", function (event) {
    ...
    var fullPath = "../../../storage/pdfs_matrimonio/" + file;
