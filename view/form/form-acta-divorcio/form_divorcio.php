...
<div class="card mx-auto w-50 card-custom">
    <div class="card-header text-center" style="background-color: #611232; color: white">INGRESAR ACTA DE DIVORCIO</div>
        <div class="card-body">
            <form action="../../../controladores/acta_divorcio/insertar_acta.php" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group mb-3 d-flex flex-column">
                    <label for="nombre_divorciado1" class="form-label">NOMBRE DIVORCIADO 1</label>
                    <input type="text" class="form-control" name="nombre_divorciado1" id="nombre_divorciado1" aria-describedby="helpId" placeholder="" required/>
                </div>

                <div class="form-group mb-3 d-flex flex-column">
                    <label for="nombre_divorciado2" class="form-label">NOMBRE DIVORCIADO 2</label>
                    <input type="text" class="form-control" name="nombre_divorciado2" id="nombre_divorciado2" aria-describedby="helpId" placeholder="" required/>
                </div>

                <div class="form-group mb-3 d-flex flex-column">
                    <label for="fecha_divorcio" class="form-label">FECHA DE DIVORCIO</label>
                    <input type="date" class="form-control" name="fecha_divorcio" id="fecha_divorcio" aria-describedby="helpId" placeholder="" required/>
                </div>

                <div class="form-group mb-3 d-flex flex-column">
                    <label for="disolucion" class="form-label">DISOLUCION</label>
                    <input type="text" class="form-control" name="disolucion" id="disolucion" aria-describedby="helpId" placeholder="" required/>
                </div>
